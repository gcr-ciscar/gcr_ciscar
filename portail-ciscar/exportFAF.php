...
if (!isset($_GET['action']) or (isset($_GET['action']) && $_GET['action'] == 'ind'))
{
// Export Individu
...
if (!isset($_GET['action']) or (isset($_GET['action']) && $_GET['action'] == 'etab'))
{
...
if (!isset($_GET['action']) or (isset($_GET['action']) && $_GET['action'] == 'roles'))
{
// Export Roles
